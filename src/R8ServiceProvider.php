...
class R8ServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__.'/../database/migrations/create_r8types_table.php.stub' => $this->app->databasePath()."/migrations/{$timestamp}_create_r8types_table.php",
            __DIR__.'/../database/migrations/create_review_r8type_table.php.stub' => $this->app->databasePath()."/migrations/{$timestamp}_create_review_r8type_table.php",
